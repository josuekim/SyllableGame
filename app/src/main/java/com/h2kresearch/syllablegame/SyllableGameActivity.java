...
public class SyllableGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //동적 이미지뷰 추가 코드 샘플
        float xPixels = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 77, getResources().getDisplayMetrics());
        float yPixels = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 96, getResources().getDisplayMetrics());
    ...
    class ImageDrag extends View.DragShadowBuilder{
        ...
        public void onProvideShadowMetrics(Point shadowSize, Point shadowTouchPoint) {
            ...
            float xPixels = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 250, getResources().getDisplayMetrics());
            float yPixels = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 250, getResources().getDisplayMetrics());
            ...
            switch (event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view != null){
                        ...
                        if(frame_consonant.getChildCount() == 1 && (frame_vowelLeft.getChildCount() == 1 || frame_vowelBottom.getChildCount() == 1)){
                ...
                case DragEvent.ACTION_DRAG_ENDED:
                    ...
                    if(frame_consonant.getChildCount() == 1 && (frame_vowelLeft.getChildCount() == 1 || frame_vowelBottom.getChildCount() == 1)){
                        ...
                        if(completeCnt != 10){
                            completeCnt++;
                            int resourceId = getResources().getIdentifier("count"+completeCnt,"drawable", getPackageName());
